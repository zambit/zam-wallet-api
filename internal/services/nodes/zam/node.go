...
func (node *zamNode) getMasterPass() string {
...
// IsConfirmed
func (node *zamNode) IsConfirmed(ctx context.Context, hash string) (confirmed, abandoned bool, err error) {
...
// GetIncoming
func (node *zamNode) GetIncoming(ctx context.Context) (txs []nodes.IncomingTxDescr, err error) {
	type resT struct {
...
func (node *zamNode) getBestBlockIndex(ctx context.Context) (index int, err error) {
...
func (node *zamNode) foreachAddress(
	ctx context.Context,
...
func (node *zamNode) doRPCCall(ctx context.Context, method string, output interface{}, params ...interface{}) (err error) {
...
var errESRateLimit = errors.New("zam node: ES rate limit")

func (node *zamNode) doESCall(
	ctx context.Context,
