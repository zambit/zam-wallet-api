...
import wallets "git.zam.io/wallet-backend/wallet-api/internal/services/nodes"
...
func (_m *ICoordinator) Generator(coinName string) (wallets.IGenerator, error) {
	ret := _m.Called(coinName)

	var r0 wallets.IGenerator
	if rf, ok := ret.Get(0).(func(string) wallets.IGenerator); ok {
		r0 = rf(coinName)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(wallets.IGenerator)
		}
	}
